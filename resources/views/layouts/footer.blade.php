    ...
    <div class="max-w-2xl mx-auto">
      ...
      <footer class="p-4 bg-white rounded-lg md:flex md:items-center md:justify-between md:p-6">
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://vookamba.com" class="hover:underline" target="_blank">Vookamba™</a>. All Rights Reserved.
        </span>
        <ul class="flex items-center mt-0 sm:mt-0">
          <li>
            <a href="{{ route('welcome') }}" class="mr-4 text-sm text-gray-500 hover:underline md:mr-6 dark:text-gray-400">Home</a>
          </li>
          <li>
