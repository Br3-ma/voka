...
<div id="myToast" class="relative sticky top-0 px-5 py-4 border-r-8 border-blue-500 bg-white drop-shadow-lg">
    <p class="text-sm">
...
<div id="myToast" class="relative sticky top-0 px-5 py-4 border-r-8 border-orange-500 bg-white drop-shadow-lg">
    <p class="text-sm">
        <!-- Polish the toast with an circle blue "i" (stands for information) -->
