                ...
                <div class="row align-items-center pb-8">
                    ...
                    <div class="col-sm-6 col-12 text-sm-end">
                        <div class="mx-n1">
                            ...
                            <a target="_blank" href="{{ route('subscription') }}" style="background: #41004a" class="btn d-inline-flex btn-sm btn-warning mx-1">
                                <span class=" pe-2">
        ...
        <div class="container-fluid">
            ...
            <div class="card shadow border-0 mb-7">
                <div class="card-header justify-content-between d-flex w-full">
                    @if (auth()->user()->type == 'owner')
                    <h5 class="mb-0">My Businesses & Companies</h5>
                    @else
                    <h5 class="mb-0">Businesses & Companies</h5>
                    @endif
                        ...
                        <tbody>
                            @forelse ($all_businesses as $biz)
                                <tr>
                                    ...
                                    <td class="text-end">
                                        @if ($biz !== null)
                                        <a target="_blank" href="{{ route('business-detail', [$biz->id] )}}" class="btn btn-sm btn-neutral">
                                        ...
                                        @endif
                                        <a href="{{ route('biz.edit', $biz->id) }}" class="btn btn-sm btn-square btn-neutral text-danger-hover">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pen" viewBox="0 0 16 16">
                                                <path d="m13.498.795.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001zm-.644.766a.5.5 0 0 0-.707 0L1.95 11.756l-.764 3.057 3.057-.764L14.44 3.854a.5.5 0 0 0 0-.708l-1.585-1.585z"/>
                                            </svg>
                                        </a>
                                        <button wire:click="delete({{ $biz->id }})" type="button" class="btn btn-sm btn-square btn-neutral text-danger-hover">
                                            <i class="bi bi-trash"></i>
                                        </button>
                                    </td>
                                </tr>
