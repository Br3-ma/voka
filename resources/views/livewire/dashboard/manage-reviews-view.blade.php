                    ...
                    <table class="table table-hover table-nowrap">
                        ...
                        <tbody>                  
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($rev->business !== null && $rev->business->owner !== null && $rev->business->cover !== null)
                                ...
                                <td class="text-end">
                                    @if ($rev->business !== null)
                                    <a href="{{ route('business-detail', $rev->business->id )}}" class="btn btn-sm btn-neutral">
