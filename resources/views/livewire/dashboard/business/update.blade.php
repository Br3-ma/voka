                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-xxl-6 col-lg-6 p-6">
                                <div class="row">
                                    ...
                                    <input type="text" class="form-control input-default" name="name" value="{{ $biz->name}}"  placeholder="Business Name" required>
                            ...
                            <div class="col-xl-6 p-6">                                             
                                <div class="row">
                                    ...
                                    <select name="category_id" class="form-control default-select">
                                        <option value="{{ $biz->category_id}}" data-display="Select"> {{ App\Models\Category::CatName($biz->category_id) ?? 'None'}}</option>
                                        @forelse ($categories as $cat)
                                            @if ($biz->category_id != $cat->id)
                            ...
                            <div class="col-xl-12 col-xxl-12 col-lg-12">
                                <div class="row">
                                    ...
                                    <textarea cols="50" rows="10" class="form-control" name="description"  placeholder="About the business" required>
                                        {{ $biz->description }}
                                    </textarea>
                                    <div class="invalid-feedback">
                                        About the business
