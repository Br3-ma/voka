    ...
    <main class="login">
        <div class="main-login ">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <br>
                <input class="usr put" placeholder="Surname" type="text" name="lname" :value="old('lname')" required autofocus autocomplete="name">
                <br>
                <input class="usr put" placeholder="Email" type="email" name="email" :value="old('email')" required autofocus autocomplete="username">
                <br>
                <input class="usr put" placeholder="New Password" type="password" name="password" required autocomplete="new-password">
                <br>
                <input id="pass" class="pss put" placeholder="Confirm Password" type="password" name="password_confirmation" required autocomplete="new-password">
                ...
                <br>
                <a class="pass" href="{{ route('login') }}">I already have an Account</a>
                <button id="btn" class="sub" type="submit" >Sign Up</button>
                <div class="lines">
                    <div style="background-color: #a5a5a500;" class="line"></div>
                        {{-- <p style="color: #a5a5a5;" class="p-b">or</p>
                        <div style="background-color: #a5a5a5;" class="line"></div> --}}
                    </div>
                    {{-- <a style="border: 2px solid;" id="btn" class="sub pic facebook">
                        <div class="logo2"></div>Sign Up with Facebook
                    </a>
                    <a style="border: 2px solid;" id="btn" class="sub pic google">
                        <div class="logo"></div>Sign Up with Google
                    </a> --}}
                </div>
            </form>
            ...
            <div class="banner">
                ...
                <div class="contain">
                    ...
                    <p class="pp">You already have an account</p>
                    <br>
                    <a href="{{ route('login') }}" style="margin-top:10px" class="main-btn">Log In</a>
                </div>
            </div>
        </div>
    </main>
